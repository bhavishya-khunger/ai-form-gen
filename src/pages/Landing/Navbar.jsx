...
function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 p-4 animate-[fade-in_0.8s_ease-out]">
      <div className="container mx-auto max-w-4xl flex justify-between items-center px-6 py-3 border border-white/20 bg-black/30 backdrop-blur-lg rounded-full shadow-lg shadow-white/5">
        ...
        {/* CTA Button */}
        <button className="flex gap-2 items-center px-4 py-2 rounded-full text-white text-sm font-medium 
